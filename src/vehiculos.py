...
def modificar_vehiculo(lista_vehiculos):
    ...
    try:
        ...
        for vehiculo in lista_vehiculos:
            if lista_vehiculos["patente"] == patente:
                break
        else:
        ...
        nuevo_marca = input(f"Marca actual: {lista_vehiculos['marcas']}: ").strip()
        if nuevo_marca:
            lista_vehiculos["modelo"] = nuevo_marca
        
        nuevo_modelo = input(f"Año (actual: {lista_vehiculos['anio']}): ").strip()
        if nuevo_modelo:
            lista_vehiculos["marca"] = nuevo_modelo
        
        nuevo_anio = ut.validar_año()
        if nuevo_anio:
            lista_vehiculos["anio"] = nuevo_anio
